...
@section('title','Adopción - AdoptPets')

@section('body-class', 'Adopcion')

@section('extra-css')
    <style>
        {!! file_get_contents(resource_path('css/adopcion.css')) !!}
    </style>
@endsection
                ...
                <div class="mascotas-grid">
                    ...
                    <div class="mascota-card">
                        <div class="mascota-imagen">
                            <img src="{{ asset('images/mascota1.jpg') }}" alt="Thomas - Gato Criollo" />
                        ...
                        <div class="mascota-info">
                            ...
                            <div class="acciones">
                                <button class="btn-adoptar">Adoptarlo</button>
                    ...
                    <div class="mascota-card">
                        <div class="mascota-imagen">
                            <img src="{{ asset('images/mascota2.jpg') }}" alt="Luna - Gata Criolla" />
                            <div class="estado-badge disponible">Disponible</div>
                        </div>
                        <div class="mascota-info">
                    ...
                    <div class="mascota-card">
                        <div class="mascota-imagen">
                            <img src="{{ asset('images/mascota3.jpg') }}" alt="Max - Perro Criollo" />
                        ...
                        <div class="mascota-info">
                            ...
                            <div class="acciones">
                                <button class="btn-adoptar disabled">Adoptado</button>
                                <button class="btn-info">En adopción</button>
                                <button class="btn-apadrinar">Sin apadrinar</button>
                            </div>
                        </div>
                    ...
                    <div class="mascota-card">
                        <div class="mascota-imagen">
                            <img src="{{ asset('images/mascota4.jpg') }}" alt="Bella - Perra Criolla" />
                            <div class="estado-badge disponible">Disponible</div>
                        </div>
                        <div class="mascota-info">
                    ...
                    <div class="mascota-card">
                        <div class="mascota-imagen">
                            <img src="{{ asset('images/mascota5.jpg') }}" alt="Rocky - Perro Criollo" />
                            <div class="estado-badge disponible">Disponible</div>
                        </div>
                        <div class="mascota-info">
                    ...
                    <div class="mascota-card">
                        <div class="mascota-imagen">
                            <img src="{{ asset('images/mascota6.jpg') }}" alt="Mimi - Gata Criolla" />
                            <div class="estado-badge disponible">Disponible</div>
                        </div>
                        <div class="mascota-info">
